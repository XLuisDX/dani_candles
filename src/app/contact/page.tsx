...
export default function ContactPage() {
  ...
  return (
    <main className="relative mx-auto max-w-7xl px-4 py-12 sm:px-6 sm:py-14 md:py-16 lg:px-8 lg:py-20 overflow-hidden">
      ...
      <div className="mt-8 grid gap-6 sm:mt-10 sm:gap-8 lg:mt-12 lg:grid-cols-[minmax(0,2fr)_minmax(0,1fr)]">
          ...
          <div className="space-y-8 sm:space-y-10 md:space-y-12">
            ...
            <div>
              ...
              <motion.textarea
                ...
                onChange={handleChange}
                rows={6}
                className="mt-2 w-full resize-none rounded-xl border border-dc-ink/10 bg-white/80 px-4 py-3.5 text-sm text-dc-ink shadow-sm outline-none transition-all placeholder:text-dc-ink/40 focus:border-dc-caramel/50 focus:bg-white focus:shadow focus:ring-4 focus:ring-dc-caramel/10 dark:border-white/10 dark:bg-white/5 dark:text-white dark:placeholder:text-white/40 dark:focus:bg-white/10 sm:mt-2.5 sm:rounded-2xl sm:px-5 sm:py-4"
            ...
            {success && (
              <motion.div
                initial={{ opacity: 0, scale: 0.95 }}
                animate={{ opacity: 1, scale: 1 }}
                className="rounded-xl border border-emerald-500/20 bg-emerald-50/80 px-4 py-3 text-xs font-medium text-emerald-700 dark:bg-emerald-900/20 dark:text-emerald-400 sm:rounded-2xl sm:px-5 sm:py-3.5 sm:text-sm"
              >
        ...
        <div className="space-y-5 sm:space-y-6">
          <motion.div
            ...
            animate={{ opacity: 1, x: 0 }}
            transition={{ delay: 0.5, duration: 0.6 }}
            className="rounded-2xl border border-dc-ink/8 bg-white/95 p-6 shadow-lg backdrop-blur-xl dark:border-white/10 dark:bg-[#1a1a1a]/95 sm:rounded-3xl sm:p-8"
          >
            ...
            <div className="mt-5 space-y-4 sm:mt-6 sm:space-y-5">
              <div className="flex items-start gap-3.5 sm:gap-4">
                <div className="flex h-9 w-9 flex-shrink-0 items-center justify-center rounded-full border border-dc-ink/10 bg-dc-cream/50 dark:border-white/10 dark:bg-white/5 sm:h-10 sm:w-10">
                  <FaEnvelope className="h-3.5 w-3.5 text-dc-caramel sm:h-4 sm:w-4" />
                </div>
                <div>
                  <p className="text-[9px] font-bold uppercase tracking-[0.15em] text-dc-ink/40 dark:text-white/40 sm:text-[10px]">
                    Email
                  </p>
                  <a
                    href="mailto:hello@danicandles.com"
                    className="mt-1 text-xs font-medium text-dc-ink transition-colors hover:text-dc-caramel dark:text-white sm:text-sm"
                  >
              ...
              <div className="flex items-start gap-3.5 sm:gap-4">
                ...
                <div>
                  ...
                  <p className="mt-1 text-xs font-medium text-dc-ink dark:text-white sm:text-sm">
                    Dickson, TN
                  </p>
                </div>
              </div>
          ...
          >
            ...
            <div className="mt-5 flex gap-3 sm:mt-6">
              <motion.a
                ...
                className="flex h-11 w-11 items-center justify-center rounded-full border border-dc-ink/10 bg-dc-cream/50 text-dc-caramel transition-colors hover:border-dc-caramel/30 hover:bg-dc-caramel hover:text-white dark:border-white/10 dark:bg-white/5 sm:h-12 sm:w-12"
              >

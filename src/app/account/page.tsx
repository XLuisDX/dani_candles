...
export default function AccountPage() {
  ...
  if (loading) {
    return (
      <main className="relative mx-auto max-w-5xl px-4 py-12 sm:px-6 sm:py-14 md:py-16 lg:px-8 lg:py-20 mt-16">
        <motion.div
  ...
  return (
    <main className="relative mx-auto max-w-5xl px-4 py-12 sm:px-6 sm:py-14 md:py-16 lg:px-8 lg:py-20 mt-16">
      ...
      <motion.div
        ...
        className="pointer-events-none absolute -bottom-16 left-8 h-48 w-48 rounded-full bg-dc-caramel blur-3xl sm:left-10 sm:h-56 sm:w-56 md:h-64 md:w-64"
      />
      ...
      >
        <motion.div
          ...
          className="rounded-2xl border border-dc-ink/8 bg-white/95 p-6 shadow-sm backdrop-blur-xl sm:rounded-3xl sm:p-8"
        >
          ...
          <div className="mt-5 space-y-3.5 sm:mt-6 sm:space-y-4">
            <div>
              <p className="text-[10px] font-semibold uppercase tracking-[0.2em] text-dc-ink/40 sm:text-xs">
                Email
              </p>
              <p className="mt-1 text-sm font-medium text-dc-ink sm:mt-1.5 sm:text-base">
          ...
          <motion.div
            ...
            className="mt-6 rounded-xl border border-dc-ink/8 bg-dc-sand/30 px-4 py-3.5 sm:mt-8 sm:rounded-2xl sm:px-5 sm:py-4"
          >
        ...
        >
          ...
          <motion.div
            ...
            animate={{ opacity: 1, y: 0 }}
            transition={{ delay: 0.7 }}
            className="mt-6 flex flex-col gap-2 rounded-xl border border-dc-ink/8 bg-dc-sand/30 px-4 py-3.5 sm:mt-8 sm:flex-row sm:items-center sm:justify-between sm:rounded-2xl sm:px-5 sm:py-4"
          >

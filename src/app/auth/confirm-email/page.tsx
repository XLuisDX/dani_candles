    ...
    <main className="relative mx-auto flex min-h-[calc(100vh-200px)] max-w-2xl flex-col items-center justify-center px-4 py-12 sm:px-6 sm:py-16 md:py-20">
      ...
      >
        ...
        <motion.div
          ...
          className="mx-auto mb-6 inline-flex items-center gap-2 rounded-full border border-dc-ink/8 bg-white/90 px-4 py-1.5 shadow-sm sm:gap-2.5 sm:px-5 sm:py-2"
        >
          <motion.span
        ...
        >
          ...
          <p className="text-sm leading-relaxed text-dc-ink/70 sm:text-base">
            Click the <strong className="font-semibold text-dc-ink">Confirm Email Address</strong> button in the email to activate your account and start exploring our collection of handcrafted candles.
          </p>
        </motion.div>

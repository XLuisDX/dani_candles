    ...
    return (
      <main className="relative mx-auto flex min-h-[calc(100vh-200px)] max-w-md flex-col items-center justify-center px-4 py-12 sm:px-6 sm:py-16 md:py-20">
        <motion.div
          ...
          className="relative w-full rounded-2xl border border-dc-ink/8 bg-white/95 p-8 shadow-lg backdrop-blur-xl dark:border-white/10 dark:bg-[#1a1a1a]/95 sm:rounded-3xl sm:p-10"
        >
          <motion.div
            initial={{ scale: 0 }}
            animate={{ scale: 1 }}
          ...
          <h2 className="mb-4 text-center font-display text-2xl font-semibold text-dc-ink dark:text-white sm:text-3xl">
            Check your email
          </h2>

          <p className="mb-6 text-center text-sm leading-relaxed text-dc-ink/70 dark:text-white/70 sm:text-base">
          ...
          <div className="mb-8 rounded-xl border border-dc-ink/10 bg-dc-sand/20 p-4 dark:border-white/10 dark:bg-white/5">
            <p className="text-xs text-dc-ink/70 dark:text-white/70 sm:text-sm">
              Click the <strong className="font-semibold text-dc-ink dark:text-white">Reset Password</strong> button in the email to create a new password. The link will expire in 1 hour.
            </p>
          </div>

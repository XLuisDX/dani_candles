  ...
  return (
    <main className="relative mx-auto max-w-7xl px-4 py-8 sm:px-6 md:py-12 lg:px-8 mt-0">
          ...
          return (
            ...
            >
              <motion.div
                ...
                transition={{ duration: 0.6, ease: [0.22, 1, 0.36, 1] }}
                className={`relative overflow-hidden rounded-2xl border border-dc-ink/8 bg-white/95 p-2 shadow-lg backdrop-blur-xl sm:rounded-3xl ${
                  !isEven ? "lg:col-start-2" : ""
                }`}
              >
                <div className="aspect-square overflow-hidden rounded-xl bg-dc-sand/20 sm:rounded-2xl">
                  <img
              ...
              <div className={!isEven ? "lg:col-start-1 lg:row-start-1" : ""}>
                ...
                >
                  ...
                  <h2 className="mt-4 font-display text-3xl font-semibold text-dc-ink sm:mt-5 sm:text-4xl md:mt-6 md:text-5xl">
                    {fragrance.name}
                  </h2>
                  ...
                  <div className="mt-6 rounded-xl border border-dc-ink/8 bg-dc-cream/50 p-5 backdrop-blur-sm sm:mt-8 sm:rounded-2xl sm:p-6">
                  ...
                  <div className="mt-5 rounded-xl border border-dc-ink/8 bg-white/90 px-5 py-3.5 backdrop-blur-sm sm:mt-6 sm:rounded-2xl sm:px-6 sm:py-4">
                    <p className="text-[9px] font-bold uppercase tracking-[0.2em] text-dc-ink/50 sm:text-[10px]">
                      Scent Notes
                    </p>
                    <p className="mt-1.5 font-display text-xs text-dc-ink sm:mt-2 sm:text-sm">
                      {fragrance.notes}
                    </p>
                  </div>
                </motion.div>
      ...
      <motion.section
        ...
        className="relative mt-24 rounded-2xl border border-dc-ink/8 bg-gradient-to-br from-dc-cream to-white p-8 shadow-lg backdrop-blur-xl sm:mt-28 sm:rounded-3xl sm:p-10 md:mt-32 md:p-12 lg:p-16"
      >
          ...
          <div className="mt-8 grid gap-4 sm:grid-cols-3 sm:gap-6 md:mt-10">
            {[
              ...
              <motion.div
                ...
                className="rounded-xl border border-dc-ink/8 bg-white/90 px-5 py-5 backdrop-blur-sm sm:rounded-2xl sm:px-6 sm:py-6"
              >
                <p className="text-[9px] font-bold uppercase tracking-[0.2em] text-dc-ink/50 sm:text-[10px]">
                  {item.label}
                </p>
                <p className="mt-1.5 font-display text-xl font-semibold text-dc-ink sm:mt-2 sm:text-2xl">
                  {item.value}
                </p>
              </motion.div>
            ))}

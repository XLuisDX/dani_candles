...
export default function CollectionsPage() {
  ...
  return (
    <main className="relative mx-auto max-w-7xl overflow-hidden px-4 py-8 sm:px-6 md:py-12 lg:px-8">
      ...
      {!loading && !error && collections.length > 0 && (
        <>
          ...
          >
            {collections.map((collection, index) => (
              <motion.article
                ...
                className={`group relative overflow-hidden rounded-2xl border border-dc-ink/8 bg-white/95 shadow-sm backdrop-blur-xl transition-shadow duration-500 hover:shadow-xl dark:border-white/10 dark:bg-[#1a1a1a]/95 sm:rounded-3xl ${
                ...
                >
                  ...
                  >
                    {collection.image_url ? (
                      ...
                      <div className="flex h-full w-full items-center justify-center bg-gradient-to-br from-dc-cream/50 to-dc-sand/30 dark:from-white/5 dark:to-white/10">
                        <p className="text-xs font-semibold uppercase tracking-[0.2em] text-dc-ink/40 dark:text-white/40 sm:text-sm">
                          No Image
                        </p>
                      </div>
                    )}
          ...
          <motion.section
            ...
            className="relative mt-16 rounded-2xl border border-dc-ink/8 bg-gradient-to-br from-dc-cream to-white p-8 shadow-lg backdrop-blur-xl dark:border-white/10 dark:from-[#1a1a1a] dark:to-[#222] sm:mt-20 sm:rounded-3xl sm:p-10 md:mt-24 md:p-12 lg:p-16"
          >
